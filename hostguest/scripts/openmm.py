...
class AmoebaVdwForce(Force):
    ...
    def setParticleParameters(self, particleIndex, parentIndex, sigma, epsilon, reductionFactor):
        """
        ...
        """
        return _openmm.AmoebaVdwForce_setParticleParameters(self, particleIndex, parentIndex, sigma, epsilon, reductionFactor)
    ...
    def addParticle(self, parentIndex, sigma, epsilon, reductionFactor):
        """
        ...
        """
        return _openmm.AmoebaVdwForce_addParticle(self, parentIndex, sigma, epsilon, reductionFactor)
    ...
    def setEpsilonCombiningRule(self, epsilonCombiningRule):
        ...
        epsilonCombiningRule : string
            epsilon combining rule: 'ARITHMETIC', 'GEOMETRIC'. 'HARMONIC', 'HHG'
        """
...
class MonteCarloAnisotropicBarostat(Force):
    ...
    def getTemperature(self):
        ...
        """
        val = _openmm.MonteCarloAnisotropicBarostat_getTemperature(self)
    ...
    def setTemperature(self, temp):
        ...
        """
        return _openmm.MonteCarloAnisotropicBarostat_setTemperature(self, temp)
    ...
    def __init__(self, *args):
        """
        __init__(self, defaultPressure, temperature, scaleX=True, scaleY=True, scaleZ=True, frequency=25) -> MonteCarloAnisotropicBarostat
        __init__(self, defaultPressure, temperature, scaleX=True, scaleY=True, scaleZ=True) -> MonteCarloAnisotropicBarostat
        __init__(self, defaultPressure, temperature, scaleX=True, scaleY=True) -> MonteCarloAnisotropicBarostat
        __init__(self, defaultPressure, temperature, scaleX=True) -> MonteCarloAnisotropicBarostat
        __init__(self, defaultPressure, temperature) -> MonteCarloAnisotropicBarostat
...
class RPMDIntegrator(Integrator):
    ...
    def _getStateAsLists(self, copy, getPositions, getVelocities, getForces, getEnergy, getParameters, enforcePeriodic, groups):
        """_getStateAsLists(self, copy, getPositions, getVelocities, getForces, getEnergy, getParameters, enforcePeriodic, groups) -> PyObject *"""
...
class MonteCarloBarostat(Force):
    ...
    def setTemperature(self, temp):
        ...
        temp : double
            the system temperature, measured in Kelvin.
        """
        return _openmm.MonteCarloBarostat_setTemperature(self, temp)
    ...
    def __init__(self, *args):
        ...
        __init__(self, defaultPressure, temperature) -> MonteCarloBarostat
...
class MonteCarloMembraneBarostat(Force):
    ...
    def getTemperature(self):
        ...
        Get the temperature at which the system is being maintained, measured in Kelvin.
        """
        val = _openmm.MonteCarloMembraneBarostat_getTemperature(self)
    ...
    def setTemperature(self, temp):
        ...
        temp : double
            the system temperature, measured in Kelvin.
        """
        return _openmm.MonteCarloMembraneBarostat_setTemperature(self, temp)
    ...
    def __init__(self, *args):
        """
        __init__(self, defaultPressure, defaultSurfaceTension, temperature, xymode, zmode, frequency=25) -> MonteCarloMembraneBarostat
        __init__(self, defaultPressure, defaultSurfaceTension, temperature, xymode, zmode) -> MonteCarloMembraneBarostat
...
class Context(_object):
    ...
    def _getStateAsLists(self, getPositions, getVelocities, getForces, getEnergy, getParameters, enforcePeriodic, groups):
        """_getStateAsLists(self, getPositions, getVelocities, getForces, getEnergy, getParameters, enforcePeriodic, groups) -> PyObject *"""
...
class XmlSerializer(_object):
    ...
    def _serializeStateAsLists(pos, vel, forces, kineticEnergy, potentialEnergy, time, boxVectors, params, types):
        """_serializeStateAsLists(pos, vel, forces, kineticEnergy, potentialEnergy, time, boxVectors, params, types) -> std::string"""
    ...
    def _deserializeStringIntoLists(stateAsString):
        """_deserializeStringIntoLists(stateAsString) -> PyObject *"""
...
def XmlSerializer__serializeStateAsLists(pos, vel, forces, kineticEnergy, potentialEnergy, time, boxVectors, params, types):
    """XmlSerializer__serializeStateAsLists(pos, vel, forces, kineticEnergy, potentialEnergy, time, boxVectors, params, types) -> std::string"""
    return _openmm.XmlSerializer__serializeStateAsLists(pos, vel, forces, kineticEnergy, potentialEnergy, time, boxVectors, params, types)

def XmlSerializer__deserializeStringIntoLists(stateAsString):
    """XmlSerializer__deserializeStringIntoLists(stateAsString) -> PyObject *"""
    return _openmm.XmlSerializer__deserializeStringIntoLists(stateAsString)
